 ...
 <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Update Package Data </h5>
                ...
                <form action="updatecode.php" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> GPU </label>
                            <input type="number" name="gpu" id="gpu" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            <label> Stroage Type </label>
                            <input type="text" name="stype" id="stype" class="form-control">
                        </div>

                        <div class="form-group">
                            <label> Stroage Size </label>
                            <input type="number" name="ssize" id="ssize" class="form-control">
                        </div>

                        <div class="form-group">
                            <label> Pricing_type Size </label>
                            <input type="text" name="pricingtype" id="pricingtype" class="form-control">
                        </div>
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Delete Package Data</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
              ...
              <div class="row">
                  <h2 class="card-title pl-4">UPDATE PACKAGE DATA</h2>
                  <br/><br/>
                  <div class="form-group">
                    ...
                    <table id="datatableid" class="table table-bordered table-dark">
                        <thead>
                            ...
                            <th scope="col"> PID</th>
                                ...
                                <th scope="col"> RAM</th>
                                <th scope="col"> OS </th>
                                <th scope="col"> S_type </th>
                                <th scope="col"> S_Size </th>
                                <th scope="col"> Pricing_type </th>
            ...
            ?>
                        <tbody>
                            ...
                            <td> <?php echo $row['pid']; ?> </td>
                                ...
                                <td> <?php echo $row['pricingtype']; ?> </td>
