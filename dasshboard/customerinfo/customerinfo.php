      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="card-body px-0 overflow-auto">
                          ...
                          <table  class="table table-dark" id="main" border="0" cellspacing="0">
                              <tr>
                                <td id="header">
                              ...
                              <tr>
                                <td id="table-form">
                                  <form>
                                    Select User Email: <select id="user-box">
          ...
          $.ajax({
            ...
            success : function(data){
              $.each(data, function(key, value){
                  $("#user-box").append("<option value='"  + value.email + "'>"  + "< "+ value.email + " >"+ "</option>");
              //   $("#user-box").append("<option value='" + value.username + value.email + "'>" +"< "+ value.username + ">  "+ "< "+ value.email + " >"+ "</option>");
              //   $("#user-box").append("<option value='" + value.cusername + value.email"'>" + value.username + value.email"</option>");
